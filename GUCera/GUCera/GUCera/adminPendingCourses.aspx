<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminPendingCourses.aspx.cs" Inherits="GUCera.adminPendingCourses" %>
...
<body>
    <form id="pendingCourses" runat="server">
        <div class="container table">
            <asp:Table ID="pendingCoursesTable" runat="server" Width="100%" BackColor="#48426d" ForeColor="White">
